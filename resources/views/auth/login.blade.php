                    ...
                    <div class="col-lg-4 col-md-7">
                        <div class="card border-0 mb-0">
                            <div class="card-header bg-transparent">
                                <h5 class="text-dark text-center mt-2 mb-3">{{ __('Login')}}</h5>
                            </div>
                            <div class="card-body px-lg-5 pt-0">
                                <form role="form" class="text-start" method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-3">
                                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Email" aria-label="Email" required autocomplete="email" autofocus>
                                    ...
                                    <div class="mb-3">
                                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password" placeholder="Password" aria-label="Password">
                                    ...
                                    <div class="mb-2 position-relative text-center">
                                        <p class="text-sm font-weight-bold mb-2 text-secondary text-border d-inline z-index-2 bg-white px-3">atau</p>
                                    </div>
                                    <div class="text-center">
                                        <a href="{{ route('register') }}" class="btn bg-gradient-dark w-100 mt-2 mb-4">Registrasi</a>
                                    </div>
                                </form>
                            </div>
                        </div>
